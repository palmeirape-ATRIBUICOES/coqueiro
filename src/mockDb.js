...
export const initDb = () => {
  ...
  if (existingProducts && (!existingProducts.includes("coq-prod_agua_sanitaria") || !existingProducts.includes("PRATELEIRA 1"))) {
    localStorage.removeItem("facilitadora_products");
  }
